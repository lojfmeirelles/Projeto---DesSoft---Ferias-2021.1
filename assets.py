...
def load_assets():
    ...
    assets[SHIP2_IMG] = pygame.image.load(os.path.join(IMG_DIR, 'PlayerShip2.png')).convert_alpha()
    assets[SHIP2_IMG] = pygame.transform.scale(assets['ship2_img'], (SHIP_WIDTH, SHIP_HEIGHT))
